...
CAPABILITY_REGISTRY: list[dict] = [
    ...
    },
    {
        ...
        "default": "tickflow",
        "tf_tier": "pro",
        # 插件/自定义源声明 depth5 数据集即可提供(provider 需实现 get_depth_batch,
        # 如 stock-sdk/easy-tdx); loader 白名单已开放 depth5。路由到该源时 policy 补授
        # DEPTH5_BATCH 能力, depth_service 走 provider 拉五档。
    },
    {
        "id": "financial",
        "label": "财务数据",
